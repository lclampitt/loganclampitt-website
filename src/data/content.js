...
export const PROJECTS = [
  ...
  },
  {
    ...
    previewImage: '/images/gainlytics.png',
    status: ['live'],
    statusTone: 'amber',
  ...
  },
  {
    slug: 'connect-4-ai',
    title: 'Connect 4 AI',
    previewLabel: 'CONNECT 4',
    previewImage: '/connect4ai.png',
    status: ['repo'],
    statusTone: 'muted',
    desc: 'Minimax + alpha-beta opponent that plays near optimal Connect 4.',
    layout: 'compact',
    liveUrl: null,
    caseStudy: true,
...
export const PROJECT_DETAILS = {
  ...
  'connect-4-ai': {
    ...
    tag: 'AI / Game',
    description:
      'A Connect 4 implementation with an AI opponent powered by minimax and alpha-beta pruning. The AI evaluates board states several moves ahead, making it a challenging, near optimal opponent. Built as a demonstration of classical AI game tree search.',
    ...
    whatItDoes: [
      ...
      'Turn based game loop with win detection.',
    ],
